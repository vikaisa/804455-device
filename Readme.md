...
* Студент: [Виктория Исайчева](https://up.htmlacademy.ru/htmlcss/22/user/804455).
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/804455-device) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
